<template>
    <div>
      ...
      <TableSearch :formItems="formItems" @search="handleSearch"></TableSearch>
      <el-table :data="tableData" style="width: 100%; margin-top: 25px">
          ...
          <el-table-column label="操作" fixed="right">
            <template #default="scope">
              ...
              <el-button @click="handleUnpublish(scope.row)" v-if="scope.row.status === 1" text type="danger" size="small">下线</el-button>
      ...
      <ArticleDialog v-model:modelValue="dialogVisble" :article="currentArticle" :categories="categories" @sucess="handleSuccess"></ArticleDialog>
    </div>
</template>
