            ...
            <!-- 情绪评分 -->
             ...
             <div class="diary-card">
                ...
                <div class="emotion-grid">
                    <div v-for="emotion in emotionOptions" :key="emotion.name" class="emotion-card" :class="{'selected': emotion.name === diaryForm.dominantEmotion}" @click="selectEmotion(emotion.name)">
                        <el-image :src="emotion.url" style="width: 40px; height: 40px" />
             ...
             <div class="diary-card">
                ...
                <div class="detail-form">
                    ...
                    <el-input v-model="diaryForm.emotionTriggers" type="textarea" placeholder="今天什么事情影响了您的情绪？" :rows="3" maxLength="1000" show-word-limit></el-input>
                </div>
                <div class="form-group">
                    <div class="form-label">今日感想</div>
                    <el-input v-model="diaryForm.diaryContent" type="textarea" placeholder="写下您今天的想法、感受或发生的有趣的事情..." :rows="5" maxLength="2000" show-word-limit></el-input>
                </div>
                <!-- 生活指标 -->
